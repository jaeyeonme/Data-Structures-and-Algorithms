...
class Combination {
    ...
    private ArrayList<ArrayList<Position1>> result; // 모든 조합
...
public class Chicken {
    ...
    public static ArrayList<Position1> chicken = new ArrayList<>();
    public static ArrayList<Position1> house = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        for (int r = 0; r < n; r++) {
            for (int c = 0; c < n; c++) {
                arr[r][c] = sc.nextInt();
                if (arr[r][c] == 1) house.add(new Position1(r, c));        // 일반 집
                else if (arr[r][c] == 2) chicken.add(new Position1(r, c)); // 치킨집
            }
        }
